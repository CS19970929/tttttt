		...
		else
		{
			...
			case FLASH_309_NORMAL_NORMAL_VALUE:
				if (AFE_SleepMode_Judge())
				{
					...
					//if (++su16_Normal2_100msTCnt >= 10 * 60)
					if (++su16_Normal2_100msTCnt >= 1 * 60)
				...
				else
				{
					...
					// if (++su16_RTC2_100msTCnt >= 10 * 60)
					if (++su16_RTC2_100msTCnt >= 1 * 60)
...
void Fault_ChangeToMCU(void)
{
	...
	g_stCellInfoReport.CanAlarm.bits.b1BatOvp_warning = SH367309_Reg_Store.REG_BSTATUS1.bits.OV;

	//g_stCellInfoReport.CanAlarm.bits.b1BatOvp_Alarm = SH367309_Reg_Store.REG_BSTATUS1.bits.OV;
	...
	g_stCellInfoReport.CanAlarm.bits.b1BatUvp_warning = SH367309_Reg_Store.REG_BSTATUS1.bits.UV;
	...
	g_stCellInfoReport.CanAlarm.bits.b1IOcp_Alarm = SH367309_Reg_Store.REG_BSTATUS1.bits.OCD1;
	//g_stCellInfoReport.CanAlarm.bits.
	...
	g_stCellInfoReport.CanAlarm.bits.b1IOcp_warning = SH367309_Reg_Store.REG_BSTATUS1.bits.OCD2;
	...
	g_stCellInfoReport.CanAlarm.bits.b1IchgOcp_warning = SH367309_Reg_Store.REG_BSTATUS1.bits.OCC;
...
void TemperatureCheck(void)
{
	...
	g_stCellInfoReport.CanAlarm.bits.b1EnvTemOv_warning = 0;
	
	if (SH367309_Reg_Store.REG_BSTATUS2.bits.OTC || SH367309_Reg_Store.REG_BSTATUS2.bits.UTC)
	{
		g_stCellInfoReport.CanAlarm.bits.b1EnvTemOv_warning = SH367309_Reg_Store.REG_BSTATUS2.bits.OTC || SH367309_Reg_Store.REG_BSTATUS2.bits.UTC;
