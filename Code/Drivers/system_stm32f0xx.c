...
static void SetSysClock(void)
{
  ...
  if (HSEStatus == (uint32_t)0x01)
  {
	...
	#if (defined _HSE_8M_PLL_48M)
    RCC->CFGR |= (uint32_t)(RCC_CFGR_PLLSRC_PREDIV1 | RCC_CFGR_PLLXTPRE_PREDIV1 | RCC_CFGR_PLLMULL6);
    #elif (defined _HSE_12M_PLL_48M)
	RCC->CFGR |= (uint32_t)(RCC_CFGR_PLLSRC_PREDIV1 | RCC_CFGR_PLLXTPRE_PREDIV1 | RCC_CFGR_PLLMULL4);	//¸ÄÎª4±¶Æµ
	#endif
    /* Enable PLL */
    RCC->CR |= RCC_CR_PLLON;
	...
	#elif (defined _HSE_NOPLL_8M)
	SystemCoreClock = 8000000;
	#elif (defined _HSE_NOPLL_12M)
